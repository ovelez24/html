...
function login() {
    ...
    var usuarioRegex = /^[a-zA-Z0-9]+$/;//asi se establece una serie de caracteres que pueden ser admitidos
    var passRegex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/;//esto quiere decir que la contraseña tenga 8 caracteres y que tenga mayuscula, minuscula y un numero
